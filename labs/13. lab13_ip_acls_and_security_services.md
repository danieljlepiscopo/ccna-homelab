Securing networks and making sure that filters are in place to help ensure that packets travel to the correct destination are imperative in modern enterprise networks. In this lab, we will break these topics up into three different sections:
