...
<center>
  <img width="400" height="500" alt="sw1_default_desktop" class="center" src="https://github.com/user-attachments/assets/b8eee3be-8f05-44a9-b5c6-526ac51f250b" />
</center>

<center>
  <img width="400" height="500" alt="sw1_default_desktop" class="center" src="https://github.com/user-attachments/assets/29cc7a23-f28f-475d-bd52-8b654c1227d9" />
</center>
...
To check IP configuration on a Linux device, we’ll use this command on my client device:
...
- `192.168.100.2` is the WLC interface, `192.168.100.254` is the SW1 SVI gateway, and `192.168.1.10` is my Windows 11 PC’s NIC.
